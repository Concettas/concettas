...
cuisine:
  ...
  text: >-
    ...
    **CLASSIC PLATTER**-2 EGGS ANY WAY, BACON, HAM, OR WAGNER'S SAGE SAUSAGE PATTIES, HOME FRIES, CHOICE OF TOAST  (2PC), BAGEL, ENGLISH MUFFIN OR CROISSANT
    ...
    ***SIDES***                                                                
    ...
    SIDE OF LOADED HOME FRIES (BACON, ONION, GARDEN PEPPERS, CHEESE)
    ...
    ***BREAD AND ROLL CHOICES***: FARM WHITE, 7 GRAIN HONEY WHEAT, MARBLE JEWISH RYE, CHALLAH (EGG BREAD,) ITALIAN (SLICED CIABATTA), CIABATTA ROLL, ONION POPPY ROLL, WRAP, FLAKY CROISSANT,HOME BAKED BISCUITS(WHEN AVAILABLE), BAGELS. (INQUIRE FOR AVAILABLE OPTIONS), GLUTEN FREE (WHEN AVAILABLE)
    ...
    **GRILLED REUBEN SANDWICH**-   CORNED BEEF, PASTRAMI OR TURKEY
    ...
    GRILLED MARBLE RYE BREAD, SAUERKARAUT, SWISS CHEESE AND HOUSE MADE THOUSAND ISLAND DRESSING
    ...
    **CHICKEN CHEESESTEAK SUB**- CHICKEN BREAST GRILLED WITH ONIONS, LETTUCE, TOMATO, MAYO SERVED ON A GRILLED SUB ROLL   **HALF OR WHOLE**   ADD HOUSE -MADE MARINARA AND MOZZARELLA EXTRA CHARGE


    **GRILLED CHEESE**- CHOICE OF AMERICAN, PROVOLONE, CHEDDAR OR SWISS ON CHOICE BREAD      add:  PANCETTA/BACON/HAM  EXTRA CHARGE
